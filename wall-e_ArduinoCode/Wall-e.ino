//only Adafruit PWM Versions 2.2.0, 2.3.0 Possibly the newer versions but start with 2.2.0
//arduinoISP
...
#define BRK_R  8
#define SR_OE 4           // Servo shield output enable pin ***switched from pin 10? maybe it has to go there??
/*
...
int preset[][2] =  {{575,125},     //{{410,120},  // head rotation
                    {575,125},     //{532,178},  // neck top
                    {240,700},     //{120,310},  // neck bottom
                    {575,125},     //{465,271},  // eye right
                    {125,575},     //{278,479},  // eye left
                    {510,125},     //{340,135},  // arm left
                    {250,595}};    //{150,360}}; // arm right
// *****************************************************
